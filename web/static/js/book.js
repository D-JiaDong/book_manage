function book(pageSize, currentPage, opr) {
    try {
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                pageText = ' <tr align="right">' +
                    ...
                    '                   当前第' + currentPage + '页' +
                    '                    <a href="javascript:book(' + pageSize + ',' + 1 + ',\'PopularSearch\')" >首页</a>' +
                    '                    <a href="javascript:book(' + pageSize + ',' + (currentPage <= 1 ? 1 : currentPage - 1)+ ',\'PopularSearch\')" >上一页</a>' +
                    '                    <a href="javascript:book(' + pageSize + ',' + (currentPage >= totalPage ? totalPage : currentPage + 1)  + ',\'PopularSearch\')" >下一页</a>' +
                    '                    <a href="javascript:book(' + pageSize + ',' + totalPage +',\'PopularSearch\')">尾页</a>' +
