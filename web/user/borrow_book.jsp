                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="form-group" style="display: inline;">
                                                ...
                                                <input type="button" class="btn btn-primary"  value="查询" onclick="borrow_allbook(8,1,'all','select',0,0)"/>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script type="text/javascript" src="../static/js/borrow_allbook.js" ></script>
